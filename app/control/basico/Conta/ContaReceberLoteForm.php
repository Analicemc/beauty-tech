...
class ContaReceberLoteForm extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $intervalo->addItems(["mensal" => "Mensal", "quinzenal" => "Quinzenal", "semanal" => "Semanal"]);
        ...
        $dt_vencimento_inicial->setSize(130);
        $conta_dt_vencimento->setSize('100%');

        //<onBeforeAddFieldsToForm>

        //</onBeforeAddFieldsToForm>
        $row1 = $this->form->addFields([new TLabel("Cliente <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $pessoa_id], [new TLabel("Categoria <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $categoria_id], [new TLabel("Forma de pagamento <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $forma_pagamento_id]);
        $row1->layout = [' col-sm-4', ' col-sm-4', ' col-sm-4'];

        $row2 = $this->form->addFields([new TLabel("Data de vencimento inicial <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $dt_vencimento_inicial], [new TLabel("Valor <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $valor]);
        $row2->layout = [' col-sm-4', ' col-sm-4'];

        $row3 = $this->form->addFields([new TLabel("Tipo de geração <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $tipo_geracao], [new TLabel("Intervalo <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $intervalo], [new TLabel("Quantidade de contas <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $quantidade_contas], [new TLabel(' ', null, null, null, '100%'), $button_gerar_contas]);
