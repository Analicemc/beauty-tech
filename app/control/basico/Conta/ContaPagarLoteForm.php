...
class ContaPagarLoteForm extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        //</onBeforeAddFieldsToForm>
        $row1 = $this->form->addFields([new TLabel("Pessoa <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $pessoa_id], [new TLabel("Categoria <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $categoria_id], [new TLabel("Forma de pagamento <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $forma_pagamento_id]);
