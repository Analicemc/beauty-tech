...
class ContaPagarList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $filtro_rapido->addItems(["atrasadas" => "Buscar atrasadas", "abertas" => "Buscar abertas", "quitadas" => "Buscar quitadas"]);
        ...
        $row2 = $this->form->addFields([new TLabel("Pessoa:", null, '14px', null, '100%'), $pessoa_id]);
        ...
        $row4 = $this->form->addFields([new TLabel("Data de vencimento:", null, '14px', null, '100%'), $dt_vencimento, new TLabel("até", null, '14px', null), $data_vencimento_final], [new TLabel("Filtros rápidos:", null, '14px', null, '100%'), $filtro_rapido]);
        ...
        if (TSession::getValue('ContaPagarList_expand_start_hidden') === false) {
            $startHidden = false;
        } elseif (TSession::getValue('ContaPagarList_expand_start_hidden') === true) {
            $startHidden = true;
        }
        ...
        $button_cadastrar->setAction(new TAction(['ContaPagarList', 'onCadastrar']), "Cadastrar");
        ...
        $button_cadastrar_varias_contas->setAction(new TAction(['ContaPagarLoteForm', 'onShow']), "Cadastrar várias contas");
        $button_cadastrar_varias_contas->addStyleClass('btn-default');
        $button_cadastrar_varias_contas->setImage('fas:plus #009688');

        $this->datagrid_form->addField($button_cadastrar_varias_contas);

        $button_quitar_em_lote = new TButton('button_button_quitar_em_lote');
        $button_quitar_em_lote->setAction(new TAction(['QuitarContaPagarLoteForm', 'onShow']), "Quitar várias contas");
    ...
    //</generated-DatagridAction-onDelete>
    //<generated-DisplayCondition-onExibirQuitar>
    ...
    //</generated-DatagridHeaderAction-onExportPdf>
    //<generated-DatagridHeaderAction-onCadastrar>
    public function onCadastrar($param = null)
    {
        try {

            TApplication::loadPage("ContaPagarForm", 'onShow');
    ...
    public static function onExpandForm($param = null)
    {
        try {
            ...
            if (TSession::getValue('ContaPagarList_expand_start_hidden') === false) {
                TSession::setValue('ContaPagarList_expand_start_hidden', true);
            } elseif (TSession::getValue('ContaPagarList_expand_start_hidden') === true) {
                TSession::setValue('ContaPagarList_expand_start_hidden', false);
            } else {
                TSession::setValue('ContaPagarList_expand_start_hidden', !$startHidden);
            }
