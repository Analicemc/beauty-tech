...
class QuitarContaPagarLoteForm extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $contas->fillWith('meusalao', 'Conta', 'id', 'id asc', $criteria_contas);

        //<onBeforeAddFieldsToForm>

        //</onBeforeAddFieldsToForm>
        $row1 = $this->form->addFields([new TLabel("Forma de pagamento <span class='mand-field'>*</span>", '#333', '14px', null, '100%'), $forma_pagamento_id], [new TLabel("Observações:", null, '14px', null, '100%'), $obs]);
