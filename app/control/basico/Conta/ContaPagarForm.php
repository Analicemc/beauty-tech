...
class ContaPagarForm extends TPage
{
    ...
    public function __construct($param)
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Pessoa <span class='mand-field'>*</span>", null, '14px', null, '100%'), $pessoa_id], [new TLabel("Categoria <span class='mand-field'>*</span>", null, '14px', null, '100%'), $categoria_id]);
        ...
        $row5 = $this->form->addFields([new TLabel("Valor <span class='mand-field'>*</span>", null, '14px', null, '100%'), $valor], [new TLabel("Nº da parcela:", null, '14px', null, '100%'), $parcela]);
